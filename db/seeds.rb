...
sites = [Faker::StarWars.vehicle, Faker::StarWars.specie, Faker::StarWars.droid]
...
2000.times do
  ...
  @sample = Sample.new(indigo_id:id,
                       ...
                       received_date: Faker::Date.between(4.years.ago, Date.today),
                       disease:["HC", "MS", "PD", "MG", "NMO"][Faker::Number.between(0,4)],
                       gender:["F","M"][Faker::Number.between(0,1)],
                       age_at_sample:Faker::Number.between(18,99),
                       age_of_onset:Faker::Number.between(18,99),
